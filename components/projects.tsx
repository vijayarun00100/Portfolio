        ...
        <div>
            ...
            <div className="flex sm:flex-row justify-center items-center h-11/12 ">
                <div className="grid sm:grid-rows-2 sm:grid-cols-3 gap-6 list-none mt-16">
                    <li className="bg-white/10 w-96 h-11/12 rounded-2xl text-white flex flex-col">
                        ...
                        <button className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-pink-500 hover:to-yellow-500 p-3 rounded-2xl w-24 h-14 mt-11 ml-32"><a href="https://github.com/vijayarun00100/movie-recommendation-system">Source</a></button>
                    </li>
                    <li className="bg-white/10 w-96 h-11/12 rounded-2xl text-white flex flex-col">
                        ...
                        <button className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-pink-500 hover:to-yellow-500 p-3 rounded-2xl w-24 h-14 mt-5 ml-32"><a href="https://github.com/vijayarun00100/student-performance">Source</a></button>
                    </li>
                    <li className="bg-white/10 w-96 h-11/12 rounded-2xl text-white flex flex-col">
                        ...
                        <button className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-pink-500 hover:to-yellow-500 p-3 rounded-2xl w-24 h-14 mt-5 "><a href="https://github.com/vijayarun00100/student-performance">Source</a></button>
                    </li>
                    <li className="bg-white/10 w-96 h-11/12 rounded-2xl text-white flex flex-col">
                        ...
                        <button className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-pink-500 hover:to-yellow-500 p-3 rounded-2xl w-24 h-14 mt-11 ml-32"><a href="https://github.com/vijayarun00100/student-performance">Source</a></button>
                    </li>
                    <li className="bg-white/10 w-96 h-11/12 rounded-2xl text-white flex flex-col">
