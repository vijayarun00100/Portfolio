    ...
    return(
        <div>
            ...
            <div className="flex xl:flex-row justify-center items-center h-11/12 ">
                ...
                <li className="bg-white/10  w-72 sm:w-96 h-full rounded-2xl text-white flex flex-col mx-auto justify-center items-center">
                        <img src={Movie.src} alt="movie" className="w-96 h-full rounded-2xl" loading="lazy"/>
                        <h3 className="text-semibold text-2xl text-center">Movie Recommendation System</h3>
                        <p className="text-center mt-10">Discover cinematic gems tailored to your taste with our Movie Recommendation System. Utilizing advanced axlorithms, it analyzes your viewing history and preferences to suggest a curated list of films, ensuring every movie night is a hit.</p>
                        <button className=" bg-gradient-to-r from-blue-600 to-blue-400 hover:from-pink-500 hover:to-yellow-500 p-3 rounded-2xl w-24 h-14 xl:mt-11 mb-2 mt-11"><a href="https://github.com/vijayarun00100/movie-recommendation-system">Source</a></button>
                    </li>
                    <li className="bg-white/10 xl:w-96 w-72 md:w-96 h-fit  rounded-2xl text-white flex flex-col mx-auto justify-center items-center">
