    ...
    return(
        <div>
            ...
            <div className="flex xl:flex-row justify-center items-center h-11/12 ">
                ...
                <li className="bg-white/10 xl:w-96 w-72 md:w-96 h-fit xl:h-11/12 rounded-2xl text-white flex flex-col mx-auto justify-center items-center">
                        <img src={Movie.src} alt="movie" className="w-96 h-96 rounded-2xl" loading="lazy"/>
