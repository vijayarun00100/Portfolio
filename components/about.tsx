            ...
            <div className="bg-black ml-4 mr-4  sm:mr-0 sm:ml-36 sm:w-10/12 h-full bg-opacity-30 mt-24 rounded-xl items-center justify-center">
                ...
                <div className="flex sm:flex-row flex-col">
                    <div className=" flex-row sm:flex-col sm:w-1/2">
                        <p className="text-white font-semibold text-4xl mt-24 text-center sm:mr-64">About</p>
                        <img src={Work.src} alt="man with laptop" className="sm:w-80 sm:mt-36 sm:mt-42 sm:ml-10 mt-10" loading="lazy"></img>
                    </div>
